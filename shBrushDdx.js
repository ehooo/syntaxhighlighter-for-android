...
dp.sh.Brushes.Smali = function()
{
	...
	var point_keywords = 'limit inner locals '+point_end_keywords+' restart class super implements'+
	' line prologue epilogue catchall catch source enum registers var';
	...
	this.Style =	'.dp-ddx .number { color: #C00000; }' +
					'.dp-ddx .comment { color: #A4A4A4; }' +
					'.dp-ddx .vars { color: #B404AE; }' +
